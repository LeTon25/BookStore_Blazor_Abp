...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 78aad2d4-50bd-460e-88a3-23c120e34bcf
```

> `78aad2d4-50bd-460e-88a3-23c120e34bcf` is the password of the certificate, you can change it to any password you want.
